...
public final class LoyaltyCommercePlatformConnection {
	...
	public LoyaltyCommercePlatformConnection(HttpClient httpClient, String server, String lpId, String macId,
			String macKey) {
	...
	public String callLCP(String requestBody, String method) throws Exception {
		...
		String authorizationHeader = generateAuthorizationHeader(macId, macKey, contentType, requestBody,
				new URL(fullUrl), "POST");
	...
	private static String generateAuthorizationHeader(String macId, String macKey, String contentType,
			String requestBody, URL lcpURL, String method) throws Exception {
